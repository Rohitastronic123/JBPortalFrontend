...
var AuthGuard = /** @class */ (function () {
    ...
    AuthGuard.prototype.canActivate = function () {
        ...
        if (token && tokenTimestamp) {
            ...
            var tokenTime = parseInt(tokenTimestamp, 10);
...
var DashboardComponent = /** @class */ (function () {
    ...
    DashboardComponent.prototype.loadJobs = function () {
    ...
    DashboardComponent.prototype.loadApplications = function () {
    ...
    DashboardComponent.prototype.applyToJob = function (jobId) {
        // Handle job application logic
    };
    DashboardComponent.prototype.viewApplication = function (applicationId) {
        // Handle viewing application details
    };
    DashboardComponent.prototype.viewMessage = function (messageId) {
...
module.exports = ".custom-toolbar {\n  display: flex;\n  align-items: center;\n  padding: 0 16px;\n  position: fixed;\n  top: 0;\n  left: 0;\n  width: 100%;\n  z-index: 1000;\n  /* Ensures it stays on top of other elements */\n  background-color: #3f51b5;\n  /* Adjust color as needed */\n  box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);\n  /* Optional: for a shadow effect */\n  padding: 10px 20px;\n  /* Adjust padding as necessary */\n}\n.custom-toolbar .logo img {\n  height: 60px;\n  width: 80px;\n  border-radius: 5px;\n}\n.custom-toolbar .spacer {\n  flex: 1 1 auto;\n}\n.custom-toolbar .menu-button {\n  display: none;\n}\n.custom-toolbar .desktop-nav {\n  display: flex;\n  justify-content: flex-end;\n  gap: 16px;\n}\n.custom-toolbar .desktop-nav > .nav-button {\n  margin: 0 auto;\n}\n@media (max-width: 768px) {\n  .custom-toolbar .desktop-nav {\n    display: none;\n  }\n  .custom-toolbar .menu-button {\n    display: block;\n  }\n}\n::ng-deep .mat-toolbar.mat-primary {\n  background-color: #0047AB;\n}\n.nav-button {\n  margin: 20px;\n  background-color: #3498db;\n  color: white;\n}\n.nav-button:hover {\n  background-color: #2980b9;\n}\n.progress-container {\n  position: absolute;\n  bottom: 0;\n  left: 0;\n  width: 100%;\n  height: 5px;\n  /* Slightly thicker for better visibility */\n  background-color: rgba(255, 255, 255, 0.2);\n  /* Light background */\n  overflow: hidden;\n}\n.progress-container .progress-bar {\n  height: 100%;\n  width: 0;\n  background: linear-gradient(90deg, #ff6b6b, #f06595, #e056fd);\n  /* Gradient for smoother effect */\n  box-shadow: 0px 2px 8px rgba(255, 105, 135, 0.3);\n  /* Adds a soft shadow */\n  border-radius: 2px;\n  /* Rounds edges for a polished look */\n  transition: width 0.3s cubic-bezier(0.4, 0, 0.2, 1);\n  /* Smooth transition with easing */\n}\n.custom-hr {\n  border: none;\n  text-align: center;\n  overflow: visible;\n  margin: 40px 0;\n  height: 1px;\n  background-color: #bdc3c7;\n  position: relative;\n  transition: background-color 0.4s ease;\n}\n.custom-hr:after {\n  content: \"About\";\n  display: inline-block;\n  position: relative;\n  top: -14px;\n  padding: 0 10px;\n  background: white;\n  font-size: 16px;\n  color: #7f8c8d;\n  transition: color 0.4s ease, background-color 0.4s ease;\n}\n.custom-hr:hover {\n  background-color: #3498db;\n  color: black;\n}\n.custom-hr:hover:after {\n  color: #2980b9;\n  background-color: #ecf0f1;\n}\n.custom-hr-contact {\n  border: none;\n  text-align: center;\n  overflow: visible;\n  margin: 40px 0;\n  height: 1px;\n  background-color: #bdc3c7;\n  position: relative;\n  transition: background-color 0.4s ease;\n}\n.custom-hr-contact:after {\n  content: \"Contact\";\n  display: inline-block;\n  position: relative;\n  top: -14px;\n  padding: 0 10px;\n  background: white;\n  font-size: 16px;\n  color: #7f8c8d;\n  transition: color 0.4s ease, background-color 0.4s ease;\n}\n.custom-hr-contact:hover {\n  background-color: #3498db;\n  color: black;\n}\n.custom-hr-contact:hover:after {\n  color: #2980b9;\n  background-color: #ecf0f1;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
var HomeComponent = /** @class */ (function () {
    function HomeComponent(dialog, router, snackBar) {
        this.dialog = dialog;
        this.router = router;
    ...
    HomeComponent.prototype.scrollToAbout = function () {
        var aboutSection = document.getElementById('about');
        if (aboutSection) {
            aboutSection.scrollIntoView({ behavior: 'smooth', block: 'start' });
        }
    };
    HomeComponent.prototype.scrollToContact = function () {
...
var JBCardComponent = /** @class */ (function () {
    function JBCardComponent() {
        this.cards = [
            {
    ...
    JBCardComponent.prototype.ngOnInit = function () {
    };
    JBCardComponent.prototype.goToLink = function (url) {
...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(fb, http, router, dialogRef, snackBar) {
        this.fb = fb;
        this.http = http;
        this.router = router;
    ...
    LoginComponent.prototype.onLogin = function () {
        ...
        if (this.loginForm.valid) {
            var formData = this.loginForm.value; // Get form data
            console.log('Login Data:', formData); // Log data to console
            // Create headers and add Authorization if needed
            var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]();
            var token = localStorage.getItem('token'); // Retrieve token from local storage if it exists
            if (token) {
                headers = headers.set('Authorization', "Bearer " + token); // Set Authorization header with 'Bearer'
            }
            // Call the login API
            this.http.post(src_environments_environment__WEBPACK_IMPORTED_MODULE_6__["environment"].backendurl + "/login", formData, { headers: headers, observe: 'response' })
                ...
                var userName = response.body.user.name; // Get user's name from response
                if (newToken) {
                ...
                // Show success popup message
                _this.snackBar.open('Login successful!', 'Close', {
                    duration: 3000,
                    panelClass: ['success-snack-bar'],
                });
...
var ProfileComponent = /** @class */ (function () {
    ...
    ProfileComponent.prototype.fetchUserData = function () {
        var _this = this;
        var token = localStorage.getItem('token'); // Retrieve token from local storage if it exists
        if (token) {
            ...
            this.http.post(src_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].backendurl + "/user?authorization=" + encodeURIComponent(authorizationHeader), {})
                ...
                error: function (err) {
                    _this.error = 'Failed to fetch user data. Please try again later.';
                    _this.loading = false;
                    if (err.status === 401) {
                        _this.router.navigate(['/login']); // Redirect to login if unauthorized
                    }
                }
            });
        }
...
var ResumeBuilderComponent = /** @class */ (function () {
    function ResumeBuilderComponent(fb) {
        this.fb = fb;
    ...
    ResumeBuilderComponent.prototype.onSectionToggle = function (section) {
        this.selectedSections[section] = !this.selectedSections[section];
    };
    ResumeBuilderComponent.prototype.togglePreview = function () {
        this.showPreview = !this.showPreview;
    };
    ResumeBuilderComponent.prototype.downloadPDF = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var pdf, content;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        pdf = new jspdf__WEBPACK_IMPORTED_MODULE_3__["default"]('p', 'pt', 'a4');
                        content = document.getElementById('resumePreview');
                        if (!content) return [3 /*break*/, 2];
                        return [4 /*yield*/, pdf.html(content, {
    ...
    ResumeBuilderComponent.ctorParameters = function () { return [
...
var ResumeBuilder2Component = /** @class */ (function () {
    function ResumeBuilder2Component() {
    ...
    ResumeBuilder2Component.prototype.ngOnInit = function () { };
    ResumeBuilder2Component.prototype.initializeResume = function () {
    ...
    ResumeBuilder2Component.prototype.addExperience = function () {
        this.resume.experiences.push(new _resume__WEBPACK_IMPORTED_MODULE_2__["Experience"]());
    };
    ResumeBuilder2Component.prototype.addEducation = function () {
        this.resume.educations.push(new _resume__WEBPACK_IMPORTED_MODULE_2__["Education"]());
    };
    ResumeBuilder2Component.prototype.addCertificate = function () {
        this.resume.certificates.push(new _resume__WEBPACK_IMPORTED_MODULE_2__["Certificate"]());
    };
    ResumeBuilder2Component.prototype.addSkill = function () {
        this.resume.skills.push(new _resume__WEBPACK_IMPORTED_MODULE_2__["Skill"]());
    };
    ResumeBuilder2Component.prototype.removeSkill = function (index) {
        this.resume.skills.splice(index, 1);
    };
    ResumeBuilder2Component.prototype.removeExperience = function (index) {
        this.resume.experiences.splice(index, 1);
    };
    ResumeBuilder2Component.prototype.removeEducation = function (index) {
        this.resume.educations.splice(index, 1);
    };
    ResumeBuilder2Component.prototype.removeCertificate = function (index) {
        this.resume.certificates.splice(index, 1);
    };
    ResumeBuilder2Component.prototype.addProject = function () {
        this.resume.projects.push(new _resume__WEBPACK_IMPORTED_MODULE_2__["Projects"]());
    };
    ResumeBuilder2Component.prototype.removeProject = function (index) {
        this.resume.projects.splice(index, 1);
    };
    ResumeBuilder2Component.prototype.generatePdf = function (action) {
        if (action === void 0) { action = 'open'; }
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var documentDefinition;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getDocumentDefinition()];
                    case 1:
    ...
    ResumeBuilder2Component.prototype.fileChanged = function (event) {
        var _this = this;
        var file = event.target.files[0];
        if (file) {
            var reader = new FileReader();
            reader.onload = function (e) {
                _this.resume.profilePic = e.target.result; // Store the base64 image string
            };
            reader.readAsDataURL(file);
        }
    };
    ResumeBuilder2Component.prototype.resetForm = function () {
        this.resume = new _resume__WEBPACK_IMPORTED_MODULE_2__["Resume"]();
    };
    ResumeBuilder2Component.prototype.getDocumentDefinition = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var circularImage;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        circularImage = null;
                        if (!this.resume.profilePic) return [3 /*break*/, 2];
                        return [4 /*yield*/, this.createCircularImage(this.resume.profilePic, 50)];
                    case 1:
                        circularImage = _a.sent(); // Reduced image size
                        _a.label = 2;
                    case 2: return [2 /*return*/, {
                            content: [
    ...
    ResumeBuilder2Component.prototype.createHeaderSection = function () {
        return {
            stack: [
    ...
    ResumeBuilder2Component.prototype.createContactSection = function (circularImage) {
        return {
            columns: [
                {
                    stack: [
    ...
    ResumeBuilder2Component.prototype.createProfessionalSummarySection = function () {
        return {
            stack: [
    ...
    ResumeBuilder2Component.prototype.createSkillsSection = function () {
        var skills = this.resume.skills || [];
        return {
            stack: [
                { text: 'Skills', style: 'sectionHeader' },
                {
                    table: {
                        ...
                        body: [
                            skills.slice(0, 5).map(function (skill) { return ({
    ...
    ResumeBuilder2Component.prototype.createProfessionalExperienceSection = function () {
        var experiences = this.resume.experiences || [];
        return {
            stack: [
                { text: 'Professional Experience', style: 'sectionHeader' },
                {
                    table: {
                        ...
                        ].concat((experiences.length > 0 ?
                            experiences.slice(0, 2).map(function (exp) { return [
    ...
    ResumeBuilder2Component.prototype.createProjectsSection = function () {
        return {
            stack: [
                { text: 'Projects', style: 'sectionHeader' },
                {
                    table: {
                        ...
                        ].concat((this.resume.projects || []).slice(0, 3).map(function (project) { return [
    ...
    ResumeBuilder2Component.prototype.createEducationSection = function () {
        return {
            stack: [
                { text: 'Education', style: 'sectionHeader' },
                {
                    table: {
                        ...
                        ].concat((this.resume.educations || []).slice(0, 2).map(function (edu) { return [
    ...
    ResumeBuilder2Component.prototype.createCertificationsSection = function () {
        return {
            stack: [
                { text: 'Certifications', style: 'sectionHeader' },
                {
                    table: {
                        ...
                        ].concat((this.resume.certificates || []).slice(0, 2).map(function (cert) { return [
    ...
    ResumeBuilder2Component.prototype.createLineSeparator = function () {
        return { canvas: [{ type: 'line', x1: 0, y1: 0, x2: 520, y2: 0, lineWidth: 0.5, color: '#999' }], margin: [0, 1, 0, 1] };
    };
    ResumeBuilder2Component.prototype.getStyles = function () {
        return {
    ...
    ResumeBuilder2Component.prototype.getDefaultStyle = function () {
        return {
            fontSize: 12,
            columnGap: 10,
        };
    };
    ResumeBuilder2Component.prototype.createCircularImage = function (imageSrc, size) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var img;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                img = new Image();
    ...
    return ResumeBuilder2Component;
}());
...
var ResumeUploadComponent = /** @class */ (function () {
    function ResumeUploadComponent(fb, http) {
        this.fb = fb;
        this.http = http;
    ...
    ResumeUploadComponent.prototype.ngOnInit = function () { };
    // Handle file input click
    ResumeUploadComponent.prototype.onFileSelect = function (event) {
        var file = event.target.files[0];
        if (file) {
    ...
    // File upload handler
    ResumeUploadComponent.prototype.fileUpload = function (event) {
        var _this = this;
        var file = event.target.files[0];
        if (file) {
            ...
            this.http.post('http://localhost:5000/upload_resume', formData).subscribe(function (response) {
                // Populate the form with the extracted data
                console.log(response);
                _this.resumeForm.patchValue(response);
                _this.resumeUploaded = true; // Set flag to true after successful upload and parse
            }, function (error) {
    ...
    ResumeUploadComponent.prototype.saveResume = function () {
...
var SignupComponent = /** @class */ (function () {
    ...
    SignupComponent.prototype.onStateChange = function (selectedState) {
        console.log('State changed:', selectedState);
        var state = this.states.find(function (s) { return s.state === selectedState; });
